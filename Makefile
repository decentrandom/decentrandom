...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=go-rand \
		  -X github.com/cosmos/cosmos-sdk/version.ServerName=randd \
		  -X github.com/cosmos/cosmos-sdk/version.ClientName=randcli \
