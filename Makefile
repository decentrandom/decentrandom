...
localnet-start: localnet-stop
	@if ! [ -f build/node0/randd/config/genesis.json ]; then docker run --rm -v $(CURDIR)/build:/randd:Z tendermint/randnode testnet --v 5 -o . --starting-ip-address 192.168.10.2; fi
