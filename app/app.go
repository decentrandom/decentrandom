...
func NewRandApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	app.mm.SetOrderInitGenesis(genaccounts.ModuleName, distr.ModuleName,
		...
		gov.ModuleName, mint.ModuleName, crisis.ModuleName, rand.ModuleName, genutil.ModuleName)
	...
	app.MountStores(app.keyMain, app.keyAccount, app.keyStaking, app.keyMint,
		...
		app.keyParams, app.tkeyParams, app.keyRand, app.tkeyStaking, app.tkeyDistr)
